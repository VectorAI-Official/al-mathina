...
async function openCreateModal() {
    ...
    // Initialize stock mode to individual (default for new products)
...
async function handleProductSubmit(e) {
    ...
    try {
        ...
        if (inventoryId) {
            ...
            console.log('   📦 Inventory Link:', inventoryId);
            // When linked to inventory, stock is managed centrally
            productData.stock = 0;
            console.log('   ℹ️ Stock set to 0 (managed via inventory)');
        } else {
            console.log('   ℹ️ No inventory link - using individual stock');
        }
...
// Switch stock management mode
function switchStockMode(mode) {
    const individualMode = document.getElementById('individualStockMode');
    const inventoryMode = document.getElementById('inventoryLinkedMode');
    ...
    if (mode === 'individual') {
        // Show individual stock, hide inventory
        individualMode.style.display = 'block';
        inventoryMode.style.display = 'none';

        // Make stock required, clear inventory
        ...
        // Show inventory, hide individual stock
        individualMode.style.display = 'none';
        inventoryMode.style.display = 'block';

        // Make stock not required (will be managed by inventory)
        stockInput.required = false;
        stockInput.value = '0'; // Set to 0 when linked
    }
}
